...
HarmonicSeries::playNote(const ChannelConfiguration & channel_config, float input_azimuth, float frequency, float input_detune, float input_velocity, float start_phase) const {
