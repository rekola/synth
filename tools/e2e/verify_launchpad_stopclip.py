...
its own LED (note 11 / led index 0x0b) switches from a static color to a
real hardware pulse (green, matching the Novation/Ableton convention for a
currently-playing clip slot), then presses CC49 (the
